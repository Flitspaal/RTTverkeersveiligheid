...
#define warning 30
#define knopPin 5
#define groenLichtS 4
#define oranjeLichtS 3
#define roodLichtS 2
#define echoPin 12 // attach pin D7 Arduino to pin Echo of HC-SR04
#define trigPin 13 //attach pin D8 Arduino to pin Trig of HC-SR04
